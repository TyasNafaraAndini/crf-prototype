 ...
 * - Implementasi
 *
 * Pengisian hanya dapat dilakukan ketika status CRF = Dalam Proses.
 * ---------------------------------------------------------------
 */
    ...
    <div class="container">
        ...
        <div class="crf-section">
            ...
            <div class="crf-section-body">
                ...
                <!--
                    POST IMPLEMENTATION REVIEW & IMPLEMENTASI

                    Hanya bisa diedit ketika status = Dalam Proses.
                -->
                <div class="mt-4 pt-3 border-top">
                    ...
                    <div class="crf-section-header mb-3">
                        ...
                        <h2>Post Implementation & Implementasi</h2>

                    </div>


                    <?php if ($crf['status'] === 'Dalam Proses'): ?>

                        <form
                            action="../actions/update_user_crf.php"
                            method="POST"
                        >
                            ...
                            <div class="mb-4">
                                ...
                                <small class="d-block text-muted mb-2">
                                    Proses evaluasi yang dilakukan setelah perubahan dilakukan dan sebelum perubahan tersebut diterapkan.
                                </small>
                                ...
                                <textarea
                                    ...
                                    class="form-control"
                                    rows="5"
                                    placeholder="Masukkan hasil Post Implementation Review..."
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    class="form-control"
                                    rows="5"
                                    placeholder="Masukkan pelaksanaan implementasi..."
